...
export const deliveryMilestones: readonly DeliveryMilestoneProgress[] = [
  ...
  },
  {
    ...
    plannedHours: 9,
    completionPercent: 80,
    evidence: "Complete impact input, domain-enforced transitions, decision authority, immutable history, submitted-case locking, implementation evidence, baseline-incorporation guard and report integration work; pre/post baseline reconciliation remains.",
  },
  {
    id: "M7",
    title: "Weekly report",
    ...
    evidence: "A deterministic snapshot, publication controls, signed-analysis reconciliation, named change decision authority, accessible HTML preview and print styles work; editable narrative, persisted snapshots and print/PDF visual QA remain.",
  },
  {
    id: "M8",
